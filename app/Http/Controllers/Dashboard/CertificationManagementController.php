...
class CertificationManagementController extends Controller
{
    ...
    public function storeCertification(Request $request)
    {
        $validated = $request->validate([
            ...
            'target_audience_fr' => 'nullable|string',
            'target_audience_en' => 'nullable|string',
            'training_content_fr' => 'nullable|string',
            'training_content_en' => 'nullable|string',
            'exam_structure_details_fr' => 'nullable|string',
            'exam_structure_details_en' => 'nullable|string',
            'business_outcomes_fr' => 'nullable|string',
            'business_outcomes_en' => 'nullable|string',
            'additional_information_fr' => 'nullable|string',
