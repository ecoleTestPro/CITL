...
export default function AboutUsOne() {
    ...
    return (
        <section className="relative bg-white/80 pt-24 pb-12 dark:bg-gray-900">
            <div className="container mx-auto px-4 md:px-5 lg:px-5">
                <div className="grid w-full grid-cols-1 items-center justify-start gap-12 lg:grid-cols-2">
                    ...
                    <div className="order-last grid w-full grid-cols-1 items-start justify-center gap-6 sm:grid-cols-2 lg:order-first">
                        ...
                        >
                            <img className="rounded-xl object-cover" src="/assets/images/about/citl-team-1.jpg" alt="Équipe CITL - Testing Logiciel" />
                        </SlideIn>
                    ...
                    <div className="inline-flex w-full flex-col items-center justify-center gap-10 lg:items-start">
                        <div className="flex w-full flex-col items-start justify-center gap-8">
                            ...
                            <FadeIn duration={1.2} delay={0.3} className="flex w-full flex-col items-center justify-start gap-3 lg:items-start">
                                ...
                                <p className="text-center text-base leading-relaxed font-normal text-gray-500 lg:text-start dark:text-gray-400">
                            ...
                            >
                                <div className="inline-flex flex-col items-start justify-start">
                                    ...
                                    <h6 className="text-base leading-relaxed font-normal text-gray-500 dark:text-gray-400">{t('home.certifications_count')}</h6>
                                </div>
                                <div className="inline-flex flex-col items-start justify-start">
                                ...
                                <div className="inline-flex flex-col items-start justify-start">
                                    ...
                                    <h6 className="text-base leading-relaxed font-normal text-gray-500 dark:text-gray-400">{t('home.certified_testers')}</h6>
                                </div>
                            </ScaleIn>
                        </div>
