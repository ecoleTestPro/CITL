...
export function SortableMenuItem({
    ...
    return (
        <div ref={setNodeRef} style={style}>
            <div
                className={`group mb-2 flex items-center gap-3 rounded-lg border bg-white p-3 hover:border-orange-300 hover:shadow-sm ${
                    isDragging ? 'border-orange-500 shadow-lg' : 'border-gray-200'
                }`}
