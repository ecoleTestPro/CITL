            ...
            <div className="mx-auto grid w-full max-w-(--breakpoint-xl) gap-12 px-6 py-12 lg:grid-cols-2 lg:py-0">
                ...
                <div className="relative my-auto overflow-hidden">
                    ...
                    <p className="relative mt-6 max-w-[60ch] text-lg text-foreground/80">
                        Unique structure officielle en Côte d'Ivoire chargée de
                        représenter et de promouvoir l'ISTQB®. Nous délivrons
                        les certifications ISTQB, accréditons les formateurs et
                        participons activement aux standards internationaux du
                        testing logiciel.
                    </p>
                    <div className="relative mt-12 flex items-center gap-4">
                        ...
                        <Link href="/accredited-organizations">
                            ...
                            >
                                <CirclePlay className="h-5! w-5!" /> Trouver une
                                formation
                            </Button>
                        </Link>
                    </div>
                ...
                <div
                    className="aspect-video w-full rounded-xl bg-cover bg-center bg-no-repeat lg:aspect-auto lg:h-screen lg:w-[1000px] lg:rounded-none"
                    style={{
                        backgroundImage:
                            "url('/images/hero/pexels-theo-decker-5945814.jpg')",
                    }}
                    role="img"
