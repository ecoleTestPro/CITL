...
function CoreFoundation({ category, certifications, categories }: Props) {
    ...
    return (
        <PublicLayout breadcrumbs={breadcrumbs}>
            ...
            <CertificationList certifications={certifications} categories={categories} categorySlug="core-foundation" />
        </PublicLayout>
    );
}
