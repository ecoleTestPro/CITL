    ...
    return (
        <PublicLayout>
            <Head>
                ...
                <meta property="og:description" content="Découvrez les groupes de travail du CITL dédiés au développement du test logiciel en Côte d'Ivoire." />
                <meta property="og:type" content="website" />
            </Head>
            <div className="container mx-auto px-4 py-16">
                <h1 className="text-4xl font-bold mb-6">Les groupes de travail</h1>
                <p className="text-muted-foreground">
                    Contenu de la page Les groupes de travail - À développer prochainement.
                </p>
            </div>
        </PublicLayout>
    );
