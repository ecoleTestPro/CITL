    ...
    return (
        <PublicLayout>
            <Head>
                ...
                <meta property="og:description" content="Liste des organismes de formation accrédités par le CITL pour les certifications ISTQB en Côte d'Ivoire." />
                <meta property="og:type" content="website" />
            </Head>
            <div className="container mx-auto px-4 py-16">
                <h1 className="text-4xl font-bold mb-6">Organismes accrédités par le CITL</h1>
                <p className="text-muted-foreground">
                    Contenu de la page Organismes accrédités par le CITL - À développer prochainement.
                </p>
            </div>
        </PublicLayout>
    );
