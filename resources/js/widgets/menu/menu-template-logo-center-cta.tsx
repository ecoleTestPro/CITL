...
export function MenuTemplateLogoCenterCta({ menu, isSticky = false }: Props) {
    ...
    return (
        ...
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {/* Desktop Layout: Logo - Menu (Center) - CTA Button */}
                <div className="hidden md:flex md:h-20 md:items-center md:justify-between">
                    ...
                    {menu.style_config?.show_cta && (
                        ...
                        >
                            <Link
                                href={
                                    menu.style_config.cta_url ||
                                    '/contact'
                                }
                            >
                                {menu.style_config.cta_text || 'Contact'}
                            </Link>
                        </Button>
                    )}
                </div>
